...
const DraggableColorCanvas = ({
    ...
    return (
        <div
            ref={colorAreaRef}
            className="h-48 w-full touch-auto overscroll-none rounded-xl border border-zinc-200 dark:touch-auto "
            style={{
        ...
        >
            <div
                className="color-selector border-4 border-white ring-1 ring-zinc-200 "
                style={{
                    position: "absolute",
                    width: "20px",
                    height: "20px",
...
const ColorPicker = ({ default_value = "#1C9488", onChange }: { default_value?: string; onChange?: (color: string) => void }) => {
